...
function validateBundle(input) {
  ...
  return Object.freeze({
    ...
    "web/s3-access-key.secret": storageAccessKey,
    "web/s3-secret-key.secret": storageSecretKey,
    ...
    "worker/s3-access-key.secret": storageAccessKey,
    "worker/s3-secret-key.secret": storageSecretKey,
