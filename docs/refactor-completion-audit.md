...
| GHCR 发布 | `main` 镜像 digest 为 `sha256:acb300ef17b1ea0a70b1249ae4db4e07573405229bce9e9d3a2b461cd97419b9`，并生成 SBOM/provenance；匿名 manifest 请求返回 HTTP 200，`Docker-Content-Digest` 一致 |
