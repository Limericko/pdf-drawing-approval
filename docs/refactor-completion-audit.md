...
| GHCR 发布 | `main` 镜像 digest 为 `sha256:347aeafd1e9fcf54baab871efe8bee0d40191fad433141350ded2249934c47bb`，并生成 SBOM/provenance；匿名 manifest 请求返回 HTTP 200，`Docker-Content-Digest` 一致 |
